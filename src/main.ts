...
class PinBall {
    ...
    registerEvents() {
        this.balls.addEventListener('change',() => {
            this.$balls.innerHTML='BALLS<br />' + this.balls.value;
        })

        this.score.addEventListener('change',() => {
            this.$score.innerHTML=this.score.value + '<br />' + this.high.value;
        })

        this.high.addEventListener('change',() => {
            this.$score.innerHTML=this.score.value + '<br />' + this.high.value;
        })
